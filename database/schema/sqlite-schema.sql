...
CREATE TABLE fixtures (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, home_team VARCHAR(255) DEFAULT 'AZAM FC' NOT NULL COLLATE "BINARY", away_team VARCHAR(255) NOT NULL COLLATE "BINARY", home_team_logo VARCHAR(255) DEFAULT NULL COLLATE "BINARY", away_team_logo VARCHAR(255) DEFAULT NULL COLLATE "BINARY", match_date DATETIME NOT NULL, venue VARCHAR(255) NOT NULL COLLATE "BINARY", competition_type VARCHAR(255) NOT NULL, match_type VARCHAR(255) DEFAULT 'league' NOT NULL COLLATE "BINARY", team_category VARCHAR(255) DEFAULT 'senior' NOT NULL COLLATE "BINARY", match_preview CLOB DEFAULT NULL COLLATE "BINARY", ticket_link VARCHAR(255) DEFAULT NULL COLLATE "BINARY", ticket_price NUMERIC(10, 0) DEFAULT NULL, is_home BOOLEAN DEFAULT 1 NOT NULL, status VARCHAR(255) DEFAULT 'scheduled' NOT NULL COLLATE "BINARY", created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL);
