...
@section('title', isset($fixture) ? 'Edit Fixture' : 'Add New Fixture')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        {{ isset($fixture) ? 'Edit Fixture' : 'Add New Fixture' }}
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ isset($fixture) ? route('admin.fixtures.update', $fixture) : route('admin.fixtures.store') }}" 
                          method="POST" 
                          id="fixtureForm">
                        @csrf
                        @if(isset($fixture))
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" 
                                                           ...
                                                           id="match_date" 
                                                           name="match_date" 
                                                           value="{{ old('match_date', isset($fixture) && $fixture->match_date ? $fixture->match_date->format('Y-m-d') : '') }}" 
                                                           required>
                                                    @error('match_date')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="time" 
                                                           ...
                                                           id="match_time" 
                                                           name="match_time" 
                                                           value="{{ old('match_time', isset($fixture) && $fixture->match_date ? $fixture->match_date->format('H:i') : '') }}" 
                                                           required>
                                                    @error('match_time')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                    ...
                                    <div class="card-body">
                                        @if(isset($fixture))
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-5">
                                                        <label for="home_score" class="form-label small">Home</label>
                                                        <input type="number" 
                                                    ...
                                                    <div class="col-5">
                                                        <label for="away_score" class="form-label small">Away</label>
                                                        <input type="number" 
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" 
                                                    id="status" 
                                                    name="status">
                                                <option value="scheduled" {{ old('status', $fixture->status ?? 'scheduled') == 'scheduled' ? 'selected' : '' }}>Scheduled</option>
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" 
                                                       ...
                                                       name="is_featured" 
                                                       value="1" 
                                                       {{ old('is_featured', $fixture->is_featured ?? false) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        ...
                                        {{ isset($fixture) ? 'Update Fixture' : 'Create Fixture' }}
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Set default date to today if creating new fixture
        @if(!isset($fixture))
