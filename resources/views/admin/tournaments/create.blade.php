    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Create Tournament</h4>
                            ...
                            <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('format') is-invalid @enderror" 
                                                ...
                                                <option value="group_stage" {{ old('format') == 'group_stage' ? 'selected' : '' }}>Group Stage</option>
                                            </select>
                                            @error('format')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="season" 
                                                   name="season" 
                                                   value="{{ old('season', date('Y') . '/' . (date('Y') + 1)) }}" 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="4" 
                                              placeholder="Tournament description and details...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
@push('scripts')
<script>
    // Auto-generate short name from tournament name
    document.getElementById('name').addEventListener('input', function() {
        ...
        if (!shortName.value) {
            ...
            shortName.value = short.substring(0, 10); // Limit to 10 characters
        }
    });
