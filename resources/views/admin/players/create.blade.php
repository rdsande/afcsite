...
@section('title', isset($player) ? 'Edit Player' : 'Add New Player')
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        {{ isset($player) ? 'Edit Player' : 'Add New Player' }}
                    </h3>
                    ...
                    <form action="{{ isset($player) ? route('admin.players.update', $player) : route('admin.players.store') }}" 
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control @error('team') is-invalid @enderror" 
                                                            ...
                                                            name="team" 
                                                            required>
                                                        <option value="senior" {{ old('team', $player->team_category ?? 'senior') == 'senior' ? 'selected' : '' }}>Senior Team</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="date" 
                                                           ...
                                                           id="date_of_birth" 
                                                           name="date_of_birth" 
                                                           value="{{ old('date_of_birth', isset($player) && $player->date_of_birth ? $player->date_of_birth->format('Y-m-d') : '') }}">
                                                    @error('date_of_birth')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @if(isset($player) && $player->profile_image)
                                            <div class="mb-3">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" 
                                                    ...
                                                    name="status" 
                                                    required>
                                                <option value="active" {{ old('status', $player->status ?? 'active') == 'active' ? 'selected' : '' }}>Active</option>
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" 
                                                       ...
                                                       name="is_featured" 
                                                       value="1" 
                                                       {{ old('is_featured', $player->is_featured ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="row mt-4">
                            ...
                            <small class="form-text text-muted">
                                Use the editor to add YouTube videos and other content. You can embed videos using the link tool or paste YouTube URLs directly.
                            </small>
